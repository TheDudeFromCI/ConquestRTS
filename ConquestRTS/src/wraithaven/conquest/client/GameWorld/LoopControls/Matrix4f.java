...
public class Matrix4f extends Matrix{
	...
	public Matrix transpose(){ return transpose(this); }
	public Matrix4f translate(Vector3f vec){ return translate(vec, this); }
	public Matrix4f rotate(float angle, Vector3f axis){ return rotate(angle, axis, this); }
	public Matrix4f rotate(float angle, Vector3f axis, Matrix4f dest){ return rotate(angle, axis, this, dest); }
	public Matrix4f translate(Vector3f vec, Matrix4f dest){ return translate(vec, this, dest); }
	public Matrix4f transpose(Matrix4f dest){ return transpose(this, dest); }
	public Matrix invert(){ return invert(this, this); }
	public Matrix negate(){ return negate(this); }
	public Matrix4f negate(Matrix4f dest){ return negate(this, dest); }
	...
	private static float determinant3x3(float t00, float t01, float t02, float t10, float t11, float t12, float t20, float t21, float t22){ return t00*(t11*t22-t12*t21)+t01*(t12*t20-t10*t22)+t02*(t10*t21-t11*t20); }
}