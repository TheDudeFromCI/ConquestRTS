...
public class VoxelWorldBounds{
	...
	public boolean isWithinBounds(int chunkX, int chunkY, int chunkZ){
		return chunkX>=chunkStartX&&chunkX<=chunkEndX&&chunkY>=chunkStartY&&chunkY<=chunkEndY&&chunkZ>=chunkStartZ&&chunkZ<=chunkEndZ;
	}
}