...
// spinner = new UiElement(Texture.getTexture(WraithavensConquest.assetFolder,
// "Loading Spinner.png"));
...
// fileCount = new
// File(WraithavensConquest.loadingScreenImagesFolder).list().length;
// lastPictureIndex = (int)(Math.random()*fileCount);
// background = new
// UiElement(Texture.getTexture(WraithavensConquest.loadingScreenImagesFolder,
...
// Texture newTexture =
// Texture.getTexture(WraithavensConquest.loadingScreenImagesFolder,
// lastPictureIndex+".png");
