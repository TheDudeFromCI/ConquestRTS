...
public class ZipperParticleEngine extends ChunkParticleEngine{
	...
	public ZipperParticleEngine(){
		super(1.5f, 10);
	}
	public void dispose(){}
	@Override
	public void newParticle(double time){
		// TODO Make quick accessing for the biome of a block.
		...
		// Vector3f direction =
		// new Vector3f((float)(Math.random()*2-1), (float)Math.random()*0.01f,
		...
		// batch.addParticle(new Zipper(origin, direction, speed, waveRate,
		// waveSize, life, i*0.02f, time,
		// 1-i/(length-2f), i==generator?batch:null, red, green, blue));
	}
}
